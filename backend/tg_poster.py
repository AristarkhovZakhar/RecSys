...
class Ranging:
    def __init__(self, model=None) -> None:
        self.model = model
        self._news: Dict[str, Dict[str, Union[str, float]]] = {}
    ...
    def run_ranking_push_poster(self, **kwargs):
        ti = kwargs['ti']
        summary_items = ti.xcom_pull(task_ids='get_summary')
        labeler_items = ti.xcom_pull(task_ids='get_labels')
...
class TGPoster:
    ...
    def post_messages(self, news: Dict[str, Dict[str, str, float]]) -> None:
    ...
    def run_post_messages(self, **kwargs):
        ti = kwargs['ti']
        urls_news = ti.xcom_pull(task_ids='get_ranks')
